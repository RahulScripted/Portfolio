      ...
      >
        ...
        <div className='flex flex-col items-center md:items-start'>
          ...
          <motion.p 
            ...
            transition={{ delay: 0.3, duration: 0.6 }}
          >
            SortLab is an interactive and educational web application that visually demonstrates how different sorting algorithms work step by step. Built with React and Tailwind CSS, SortLab is designed to help students, developers, and curious minds understand the logic behind popular sorting techniques through engaging animations and real-time visual feedback.
          </motion.p>
          ...
          <div className='flex justify-between gap-4 md:gap-10 mt-6 md:mt-10 max-sm:flex-col mex-sm:gap-2'>
            ...
            <a 
              className='flex items-center justify-center gap-2 rounded-md px-5 py-2 text-black bg-[#ffffffe1] hover:bg-[#ffffff44] hover:text-white font-medium transition-all duration-500' 
              href="https://github.com/RahulScripted/Sorting-Visualizer" 
              target='_blank' 
              rel="noopener noreferrer"
            >
              GitHub
      ...
      >
        ...
        <div className='flex flex-col items-center md:items-start'>
          ...
          <div className='flex justify-between gap-4 md:gap-10 mt-6 md:mt-10 max-sm:flex-col mex-sm:gap-2'>
            ...
            <a 
              className='flex items-center justify-center gap-2 rounded-md px-5 py-2 text-black bg-[#ffffffe1] hover:bg-[#ffffff44] hover:text-white font-medium transition-all duration-500' 
              href="https://github.com/RahulScripted/Bg-removal-web-application" 
              target='_blank' 
              rel="noopener noreferrer"
            >
              GitHub
            ...
            <a 
              className='flex items-center justify-center gap-2 rounded-md px-5 py-2 text-black bg-[#ffffffe1] hover:bg-[#ffffff44] hover:text-white font-medium transition-all duration-500' 
              href="https://bg-removal-web-application.vercel.app/" 
              target='_blank' 
              rel="noopener noreferrer"
            >
              Preview
      ...
      >
        ...
        <div className='flex flex-col items-center md:items-start'>
          ...
          <div className='flex justify-between gap-4 md:gap-10 mt-6 md:mt-10 max-sm:flex-col mex-sm:gap-2'>
            <a 
              className='flex items-center justify-center gap-2 rounded-md px-5 py-2 text-black bg-[#ffffffe1] hover:bg-[#ffffff44] hover:text-white font-medium transition-all duration-500' 
              href="https://github.com/RahulScripted/Full-Website/tree/main/Car%20Rental" 
              target='_blank' 
              rel="noopener noreferrer"
            >
              GitHub
            ...
            <a 
              className='flex items-center justify-center gap-2 rounded-md px-5 py-2 text-black bg-[#ffffffe1] hover:bg-[#ffffff44] hover:text-white font-medium transition-all duration-500' 
              href="https://gilded-kelpie-4a2814.netlify.app/" 
              target='_blank' 
              rel="noopener noreferrer"
            >
              Preview
